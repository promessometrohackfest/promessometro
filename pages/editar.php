...
if (!empty($id_cliente) && is_numeric($id_cliente)):
	...
	$sql = 'SELECT id, tipopromessa, nomepolitico,cargopromessa, partido_politico, nomepromessa, detalhepromessa, anopromessa, estadopromessa, cidadepromessa, status, foto FROM tab_promessas WHERE id = :id';
...
<body>
	<div class='container'>
		<fieldset>
			<legend><h1>Formulário - Edição da Promessa</h1></legend>
			...
			<?php else: ?>
				...
				<div class="form-group col-lg-4">
			      <label for="patido_politico">Partido</label>
			      <input type="text" class="form-control" id="patido_politico" name="partido_politico" value="<?=$cliente->partido_politico?>" placeholder="Informe o partido ">
			      <span class='msg-erro msg-nome'></span>
			    </div>
					     
                    <div class="form-group col-lg-12">
					<label for="detalhepromessa">Descreva a promessa</label>
                    <input  type="text" class="form-control" id="detalhepromessa"  name="detalhepromessa" value="<?=$cliente->detalhepromessa?>"></input>
					<span class='msg-erro msg-nome'></span>
                     </div>
                     
                     <div class="form-group clo-lg-4 mx-2">
				      <label for="cargopromessa">Cargo Ocupado</label>
				      <select class="form-control" name="cargopromessa" id="cargopromessa">
					    <option value="<?=$cliente->cargopromessa?>"><?=$cliente->cargopromessa?></option>
                ...
                <div class="form-group col-lg-4">
				  ...
				  <span class='msg-erro msg-tipopromessa'></span>
				    ...
				    <button type="submit" class="btn btn-warning btn-lg" id='botao'> 
				      Gravar Promessa
				    </button>
				    <a href='painel.php' class="btn btn-danger btn-lg">Cancelar</a>
						</div>
				</form>
			<?php endif; ?>
