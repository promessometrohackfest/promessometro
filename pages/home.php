      ...
      <div class="row ml-4" >
        ...
        <div class="col-md-2" style="">
          <form class="form-inline">
            <div class="input-group">
              <input type="search" class="form-control form-control-lg border-warning" id="termo" name="termo" placeholder="Ano">
            </div>
          </form>
        </div>
        <div class="col-md-3" style="">
			<button type="submit" class="btn btn-warning btn-lg border" contenteditable="true">
				<img src="images/lupa.gif" class="img-fluid" width="22">
          </button></div>
      </div>
    </div>
  </div>
