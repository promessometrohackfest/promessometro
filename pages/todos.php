...
if (empty($termo)):
	...
	$conexao = conexao::getInstance();
	$sql = 'SELECT id, tipopromessa, nomepolitico, cargopromessa, partido_politico, nomepromessa, detalhepromessa, anopromessa, estadopromessa, cidadepromessa, status, foto FROM tab_promessas WHERE nomepolitico LIKE :nomepolitico OR anopromessa LIKE :anopromessa';
	$stm = $conexao->prepare($sql);
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <select class="form-control border-warning" id="termoano" name="termoano">
