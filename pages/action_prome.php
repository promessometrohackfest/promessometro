...
<body>
	<div class='container box-mensagem-crud'>
		...
		$cargopromessa     = (isset($_POST['cargopromessa'])) ? $_POST['cargopromessa'] : '';
		$partidopromessa     = (isset($_POST['partido_politico'])) ? $_POST['partido_politico'] : '';
		...
		if ($cargopromessa == ''):
			   $mensagem .= '<li>Favor preencher o cargo a ser ocupado.</li>';
         elseif(strlen($cargopromessa) < 2):
				  $mensagem .= '<li>Formato cargo inválido.</li>';
			endif;
		
			if ($partidopromessa == ''):
			   $mensagem .= '<li>Favor preencher partido.</li>';
          elseif(strlen($cargopromessa) < 2):
				  $mensagem .= '<li>Formato partido inválido.</li>';
			endif;
		    ...
		    elseif(strlen($detalhepromessa) < 15):
				  $mensagem .= '<li>Formato Descrição muito curto.</li>';
		    endif;
            ...
            if ($tipopromessa == ''):
			   $mensagem .= '<li>Favor preencher tipo da promessa.</li>';
			endif;
		...
		if ($acao == 'incluir'):
			...
			$sql = 'INSERT INTO tab_promessas (nomepolitico, cargopromessa, partido_politico, nomepromessa, detalhepromessa, anopromessa, estadopromessa, cidadepromessa, tipopromessa, status, foto)
										VALUES(:nomepolitico, :cargopromessa, :partido_politico, :nomepromessa, :detalhepromessa, :anopromessa, :estadopromessa, :cidadepromessa, :tipopromessa, :status, :foto)';

			$stm = $conexao->prepare($sql);
			$stm->bindValue(':nomepolitico', $nome);
			$stm->bindValue(':cargopromessa', $cargopromessa);
			$stm->bindValue(':partido_politico', $partidopromessa);
		...
		if ($acao == 'editar'):
			...
			$sql = 'UPDATE tab_promessas SET nomepolitico=:nomepolitico, cargopromessa=:cargopromessa, partido_politico=:partido_politico, nomepromessa=:nomepromessa, detalhepromessa=:detalhepromessa, anopromessa=:anopromessa, estadopromessa=:estadopromessa, cidadepromessa=:cidadepromessa, tipopromessa=:tipopromessa, status=:status, foto=:foto ';
			$sql .= 'WHERE id = :id';
